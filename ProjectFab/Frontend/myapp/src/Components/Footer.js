    ...
    <div class='footer-footer bg-black text-white p-4'>
        <div class='row'>
          <div class='col-12 col-sm-12 col-md-4 col-lg-4'>
            ...
            <Link class='footer-l text-decoration-none text-white' to='https://www.instagram.com/'>Instagram</Link><br></br><br></br>
          ...
          <div class='col-12 col-sm-12 col-md-4 col-lg-4 '>
            ...
            <hr class='' />
            <p class=''>LAKSHMI ENTERPRISES<br></br> #197 1st Cross, Kenchanapura cross,<br></br> Jnana Jyothi Nagar Ullal, 80ft Ring Road Bengaluru-56<br></br>Karnataka<br></br>India<br></br> <br></br>GSTIN NUMBER : 29EXPPB7831G1Z3</p>
            <h4 class=''>Mob :</h4>
            <p class=''>+91 9019500835 , 8453498863</p>
            <h4 class=''>Email :</h4>
            <p class=''>lakshmifabricator3@gmail.com</p>
          </div>
          <div class='col-12 col-sm-12 col-md-4 col-lg-4'>
