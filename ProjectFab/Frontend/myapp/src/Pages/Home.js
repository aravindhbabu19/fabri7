...
const Home = () => {
 ...
 const goToSlide = (index) => {
  ...
  return (
    <div>
       <div class='home-div'>
        <h1 class='home-head11 ms-5 pt-5'>  QUALITY IRON <span class='service-span1'>&</span> STEEL FABRICATION WORKS</h1>
        <h2 class='home-h ms-5'>Since 1995</h2>
         <Link class='text-decoration-none' to={'/Contact'}>
         <button class='service-button ms-5 mt-3'><a class="nav-link" href="">Contact Us</a></button>
         </Link>
       </div>
       <div class='home-div1'>
        <div class='row'>
      ...
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          ...
          <img src='./Images/Fab/cont.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Container Kitchen</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/food2.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center'>Container Kiosk</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3 pb-5'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/food5.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food Cart</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/pfc.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      <div class='row'>
        ...
        <div class='col-12 col-sm-12 col-md-6 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/mst.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
    ...
    <div class='home-test'>
      <h2 class='home-what mt-5 '>what our customers say about us</h2>
